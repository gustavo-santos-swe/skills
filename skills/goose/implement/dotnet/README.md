...
Path: `skills/goose/implement/dotnet/`. Load from **`implement`** (or by name) when the change touches that concern. Prefer progressive disclosure: keep `SKILL.md` short; put deep examples in `references/`.
