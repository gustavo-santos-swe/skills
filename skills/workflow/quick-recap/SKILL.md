...
name: quick-recap
description: >-
  Use when adding or following the red/yellow/green final status block
  convention for agent responses, especially by installing managed AGENTS.md
  or CLAUDE.md instructions.
metadata:
  area: workflow
  upstream:
    repo: BuilderIO/skills
    path: skills/quick-recap
    url: https://github.com/BuilderIO/skills/tree/main/skills/quick-recap
    commit: "bc3816f8ed07e4e45c74ba4496be0e19276e0550"
    synced_at: "2026-06-27"
---
