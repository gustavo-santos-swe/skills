...
metadata:
  ...
  upstream:
    ...
    url: https://github.com/callstackincubator/agent-skills/tree/main/skills/react-native-best-practices
    commit: 41879f383b615642fa0f9332d6446778135065c1
    synced_at: "2026-07-15"
    note: "Renamed locally from react-native-best-practices to avoid collision with Software Mansion's skill of the same upstream name. The `agent-device react-devtools ...` commands in this file are a Claude Code CLI tool and likely unavailable in Cursor — treat them as optional; the manual fallback (React Native DevTools Profiler from Metro) always works. Everything else (guidelines, priorities, fixes) applies as-is."
---
