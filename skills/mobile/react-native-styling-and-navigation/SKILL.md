---
name: react-native-styling-and-navigation
description: Quick reference for basic React Native StyleSheet patterns, React Navigation setup, and Reanimated fundamentals. A boilerplate-level supplement, not an aesthetic guide — for native look-and-feel direction and design decisions, use the `react-native-design` skill instead.
metadata:
  area: mobile
  upstream:
    repo: wshobson/agents
    path: plugins/ui-design/skills/react-native-design
    url: https://github.com/wshobson/agents/tree/main/plugins/ui-design/skills/react-native-design
    commit: be57c0b2e3c05c528ca6132b87410b385718775f
    synced_at: "2026-07-15"
    note: "Renamed locally from react-native-design — upstream's name collided with our own custom native-feel design skill, and upstream content is generic StyleSheet/Navigation/Reanimated boilerplate rather than aesthetic guidance. Kept as a low-priority quick reference; react-native-design is the primary skill for design decisions."
---

# React Native Styling & Navigation Quick Reference
