...
**Lifecycle skills are filled** (research through pr-iterate, plus ask / diagnose / security-check / write-like-goose).  
**Still stubs:** `implement/react-native/*` and `implement/frontend/*` pack skills.  
`documentation` ship-docs branch is filled; ADR format was already there.
