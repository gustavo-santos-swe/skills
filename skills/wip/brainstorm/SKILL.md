---
name: brainstorm
description: Use when sharpening an idea or design before a plan exists — relentless Q&A, 2–3 approaches, freeze shared understanding. No implementation yet.
...
- Don’t implement or scaffold during brainstorm.
- Don’t ask several questions in one message.
- Don’t ask the human for facts the repo already answers.
- Don’t dump implementation detail into `CONTEXT.md`.
- Don’t force a long interview when a one-breath confirm is enough **and** the user OK’d that shortcut.
- Don’t require a committed design doc every time.
