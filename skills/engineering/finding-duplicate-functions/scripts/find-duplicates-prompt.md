...
Use this prompt in the current session for thorough semantic analysis.

Run **once per category** that has 3+ functions. Take time to compare intent, not just names.
