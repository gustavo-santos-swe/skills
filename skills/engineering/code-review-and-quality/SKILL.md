...
description: Conducts multi-axis code review. Use before merging any change. Use when reviewing code written by yourself, another agent, or a human. Use when you need to assess code quality across multiple dimensions before it enters the main branch. Complements `wip/pr-review` — use for large diffs, auth, APIs, or performance.
metadata:
  area: engineering
  upstream:
